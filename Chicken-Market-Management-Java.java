...
public class ChickenMarketApp {
    ...
    public static void main(String[] args) {
        ...
        Chicken ch = new Chicken(id, weight);

        System.out.print("Enter daily price: ");
        double dailyPrice = input.nextDouble();
        Chicken.setDailyPrice(dailyPrice);

        System.out.print("Enter necessary weight: ");
        double necessaryWeight = input.nextDouble();
        Chicken.setNecessaryWeight(necessaryWeight);
